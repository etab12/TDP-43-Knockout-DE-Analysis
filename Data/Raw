...
Raw FASTQ files are not stored in this repository due to GitHub file size limitations.

Reference Preparation

All reference files were obtained from Ensembl Release 115 (GRCh38).

1. Chromosome 2 Genome Sequence

Download chromosome 2 FASTA:
...
Extract chromosome 2 transcripts:
